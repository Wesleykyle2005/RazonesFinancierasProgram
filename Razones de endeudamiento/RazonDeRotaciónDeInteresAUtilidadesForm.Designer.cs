...
{
    partial class RazonDeRotaciónDeInteresAUtilidadesForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label9 = new Label();
            label3 = new Label();
            RazonDeInteresAUtilidadesTextBox = new TextBox();
            label2 = new Label();
            UtilidadesAntesDeInteresTextBox = new TextBox();
            CargosPorInteresesTextBox = new TextBox();
            button2 = new Button();
            ...
            label9.Name = "label9";
            label9.Size = new Size(150, 60);
            label9.TabIndex = 68;
            label9.Text = "Utilidades antes de intereses e impuestos";
            // 
            // label3
            // 
            ...
            label3.TabIndex = 70;
            label3.Text = "Razón de interés a utilidades";
            // 
            // RazonDeInteresAUtilidadesTextBox
            // 
            RazonDeInteresAUtilidadesTextBox.BackColor = Color.FromArgb(242, 193, 133);
            RazonDeInteresAUtilidadesTextBox.BorderStyle = BorderStyle.None;
            RazonDeInteresAUtilidadesTextBox.Location = new Point(300, 200);
            RazonDeInteresAUtilidadesTextBox.Multiline = true;
            RazonDeInteresAUtilidadesTextBox.Name = "RazonDeInteresAUtilidadesTextBox";
            RazonDeInteresAUtilidadesTextBox.Size = new Size(100, 20);
            RazonDeInteresAUtilidadesTextBox.TabIndex = 67;
            // 
            // label2
            // 
            ...
            label2.TabIndex = 69;
            label2.Text = "Cargos por intereses";
            // 
            // UtilidadesAntesDeInteresTextBox
            // 
            UtilidadesAntesDeInteresTextBox.BackColor = Color.FromArgb(242, 193, 133);
            UtilidadesAntesDeInteresTextBox.BorderStyle = BorderStyle.None;
            UtilidadesAntesDeInteresTextBox.Location = new Point(200, 100);
            UtilidadesAntesDeInteresTextBox.Margin = new Padding(0);
            UtilidadesAntesDeInteresTextBox.Multiline = true;
            UtilidadesAntesDeInteresTextBox.Name = "UtilidadesAntesDeInteresTextBox";
            UtilidadesAntesDeInteresTextBox.Size = new Size(100, 20);
            UtilidadesAntesDeInteresTextBox.TabIndex = 65;
            // 
            // CargosPorInteresesTextBox
            // 
            CargosPorInteresesTextBox.BackColor = Color.FromArgb(242, 193, 133);
            CargosPorInteresesTextBox.BorderStyle = BorderStyle.None;
            CargosPorInteresesTextBox.Location = new Point(550, 100);
            CargosPorInteresesTextBox.Margin = new Padding(0);
            CargosPorInteresesTextBox.Multiline = true;
            CargosPorInteresesTextBox.Name = "CargosPorInteresesTextBox";
            CargosPorInteresesTextBox.Size = new Size(100, 20);
            CargosPorInteresesTextBox.TabIndex = 66;
            // 
            // button2
            // 
            ...
            txtPromedioDeLaIndustria.TabIndex = 76;
            // 
            // RazonDeRotaciónDeInteresAUtilidadesForm
            // 
            ...
            Controls.Add(label9);
            Controls.Add(label3);
            Controls.Add(RazonDeInteresAUtilidadesTextBox);
            Controls.Add(label2);
            Controls.Add(UtilidadesAntesDeInteresTextBox);
            Controls.Add(CargosPorInteresesTextBox);
            FormBorderStyle = FormBorderStyle.None;
            Name = "RazonDeRotaciónDeInteresAUtilidadesForm";
            Text = "RazonDeRotaciónDeInteresAUtilidadesForm";
            Load += RazonDeRotaciónDeInteresAUtilidadesForm_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private TextBox RazonDeInteresAUtilidadesTextBox;
        private Label label2;
        private TextBox UtilidadesAntesDeInteresTextBox;
        private TextBox CargosPorInteresesTextBox;
