...
{
    partial class MargenDeUtilidadDeOperacionForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label9 = new Label();
            label3 = new Label();
            MargenDeUtilidadOperativaTextBox = new TextBox();
            label2 = new Label();
            VentasTextBox = new TextBox();
            UtilidadOperativaTextBox = new TextBox();
            button2 = new Button();
            ...
            label3.TabIndex = 43;
            label3.Text = "Margen de utilidad operativa";
            // 
            // MargenDeUtilidadOperativaTextBox
            // 
            MargenDeUtilidadOperativaTextBox.BackColor = Color.FromArgb(242, 193, 133);
            MargenDeUtilidadOperativaTextBox.BorderStyle = BorderStyle.None;
            MargenDeUtilidadOperativaTextBox.Location = new Point(300, 200);
            MargenDeUtilidadOperativaTextBox.Multiline = true;
            MargenDeUtilidadOperativaTextBox.Name = "MargenDeUtilidadOperativaTextBox";
            MargenDeUtilidadOperativaTextBox.Size = new Size(100, 20);
            MargenDeUtilidadOperativaTextBox.TabIndex = 40;
            // 
            // label2
            // 
            ...
            label2.TabIndex = 42;
            label2.Text = "Utilidad operativa";
            // 
            // VentasTextBox
            // 
            ...
            // 
            // UtilidadOperativaTextBox
            // 
            UtilidadOperativaTextBox.BackColor = Color.FromArgb(242, 193, 133);
            UtilidadOperativaTextBox.BorderStyle = BorderStyle.None;
            UtilidadOperativaTextBox.Location = new Point(550, 100);
            UtilidadOperativaTextBox.Margin = new Padding(0);
            UtilidadOperativaTextBox.Multiline = true;
            UtilidadOperativaTextBox.Name = "UtilidadOperativaTextBox";
            UtilidadOperativaTextBox.Size = new Size(100, 20);
            UtilidadOperativaTextBox.TabIndex = 39;
            // 
            // button2
            // 
            ...
            label5.Location = new Point(400, 198);
            label5.Name = "label5";
            ...
            txtPromedioDeLaIndustria.Location = new Point(550, 198);
            ...
            txtPromedioDeLaIndustria.TabIndex = 49;
            // 
            // MargenDeUtilidadDeOperacionForm
            // 
            ...
            Controls.Add(label9);
            Controls.Add(label3);
            Controls.Add(MargenDeUtilidadOperativaTextBox);
            Controls.Add(label2);
            Controls.Add(VentasTextBox);
            Controls.Add(UtilidadOperativaTextBox);
            FormBorderStyle = FormBorderStyle.None;
            Name = "MargenDeUtilidadDeOperacionForm";
            Text = "MargenDeUtilidadDeOperacionForm";
            Load += MargenDeUtilidadDeOperacionForm_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private TextBox MargenDeUtilidadOperativaTextBox;
        private Label label2;
        private TextBox VentasTextBox;
        private TextBox UtilidadOperativaTextBox;
