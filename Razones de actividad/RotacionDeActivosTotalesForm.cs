                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                if (activostotales != 0)
                                {
                                    ...
                                    string conclusion = $"La rotación de activos totales es de {rotaciondeactivostotales:F2} veces.\n";

                                    // Evaluar la eficiencia
                                    if (rotaciondeactivostotales < 1.0)
                                    {
                                        conclusion += "Este valor es inferior a 1.0, lo que sugiere una ineficiencia en el uso de los activos totales.";
                                    }
                                    else if (rotaciondeactivostotales > 1.0)
                                    {
                                        conclusion += "Este valor es superior a 1.0, lo que indica eficiencia en el uso de los activos totales.";
                                    }
                                    else
                                    {
                                        conclusion += "Este valor es igual a 1.0, lo que sugiere un uso equilibrado de los activos totales.";
                                    }

                                    // Comparar con el promedio de la industria si está disponible
                                    if (double.TryParse(promedioIndustriaText, out promedioIndustria))
                                    {
                                        if (rotaciondeactivostotales < promedioIndustria)
                                        {
                                            conclusion += $"\nEste valor es inferior al promedio de la industria ({promedioIndustria:F2} veces), lo que sugiere una menor eficiencia en el uso de los activos totales.";
                                        }
                                        else if (rotaciondeactivostotales > promedioIndustria)
                                        {
                                            conclusion += $"\nEste valor es superior al promedio de la industria ({promedioIndustria:F2} veces), lo que indica una mayor eficiencia en el uso de los activos totales.";
                                        }
                                        else
                                        {
                                            conclusion += $"\nEste valor es similar al promedio de la industria ({promedioIndustria:F2} veces), lo que sugiere una eficiencia comparable en el uso de los activos totales.";
                                        }
                                    }
                                    else
                                    {
